...
<div class="app-page-title">
    <div class="page-title-wrapper">
        <div class="page-title-heading">
            ...
            <div>Master Pelengkap
                <div class="page-title-subheading">Daftar seluruh data pelengkap.</div>
            </div>
        </div>
        <div class="page-title-actions">
            <a href="<?= site_url('masterpelengkap/create') ?>" class="btn btn-primary">
                <i class="fa fa-plus"></i> Tambah Pelengkap
            </a>
        </div>
    </div>
</div>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="d-flex justify-content-center align-items-center" style="gap:3px; min-width:70px;">
                        <a href="<?= site_url('masterpelengkap/edit/' . $row['id']) ?>" class="btn btn-sm btn-warning" title="Edit"
                           <?php if (empty($row['otoritas']) || $row['otoritas'] !== 'T'): ?>disabled style="pointer-events:none;opacity:0.6;"<?php endif; ?>>
                            <i class="fa fa-edit"></i>
                        </a>
                        <a href="<?= site_url('masterpelengkap/delete/' . $row['id']) ?>" class="btn btn-sm btn-danger" title="Hapus"
                           <?php if (empty($row['otoritas']) || $row['otoritas'] !== 'T'): ?>disabled style="pointer-events:none;opacity:0.6;"<?php endif; ?>
